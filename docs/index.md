...
For a walkthrough that goes all the way to a running instance synced from your source database, see the [Getting Started guide](guides/getting-started.md).
